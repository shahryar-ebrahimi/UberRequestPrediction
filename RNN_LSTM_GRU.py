...
MODEL3 = Sequential()
MODEL3.add(CuDNNGRU(30, input_shape=(TRAINx.shape[1], TRAINx.shape[2])))
MODEL3.add(Dense(4))
...
# Loss for training 
plt.figure()
plt.plot(result1.history['loss'], label='RNN')
plt.plot(result2.history['loss'], label='LSTM')
plt.plot(result3.history['loss'], label='GRU')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.title('Loss of 3 different networks for train data')
plt.show()
...
# Loss for validating
plt.figure()
plt.plot(result1.history['val_loss'], label='RNN')
plt.plot(result2.history['val_loss'], label='LSTM')
plt.plot(result3.history['val_loss'], label='GRU')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.title('Loss of 3 different networks for test data')
plt.show()
...
plt.figure()
plt.plot(result1.history['acc'], label='RNN')
plt.plot(result2.history['acc'], label='LSTM')
plt.plot(result3.history['acc'], label='GRU')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
plt.title('Accuracy of 3 different networks for train data')
plt.show()
...
plt.figure()
plt.plot(result1.history['val_acc'], label='RNN')
plt.plot(result2.history['val_acc'], label='LSTM')
plt.plot(result3.history['val_acc'], label='GRU')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
plt.title('Accuracy of 3 different networks for test data')
plt.show()
...
# *****************************************************************************
# RNN: Plotting the predicted data for four boroughs
plt.figure()
...
plt.title('RNN Network: True and Predicted Value for Test Data')
plt.xlabel('Time')
...
# *****************************************************************************
# LSTM: Plotting the predicted data for four boroughs
plt.figure()
...
plt.title('LSTM Network: True and Predicted Value for Test Data')
plt.xlabel('Time')
plt.ylabel('Values(Bronx)')
plt.legend()
plt.show()
...
plt.show()
# *****************************************************************************
# GRU: Plotting the predicted data for four boroughs
plt.figure()
...
plt.title('GRU Network: True and Predicted Value for Test Data')
plt.xlabel('Time')
plt.ylabel('Values(Bronx)')
plt.legend()
plt.show()
