...
MODEL1.compile(loss='mse', optimizer=OPT_GD, metrics=['accuracy'])
...
OPT_RMS = tensorflow.keras.optimizers.RMSprop(lr=0.0001, decay=1e-6)
MODEL2.compile(loss='mse', optimizer=OPT_RMS , metrics=['accuracy'])
...
MODEL3 = Sequential()
MODEL3.add(CuDNNLSTM(30, input_shape=(TRAINx.shape[1], TRAINx.shape[2])))
MODEL3.add(Dense(4))
...
# Loss for training 
plt.figure()
plt.plot(result1.history['loss'], label='SGD')
plt.plot(result2.history['loss'], label='RMSProp')
plt.plot(result3.history['loss'], label='Adam')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.title('Loss of 3 different optimizers for train data')
plt.show()
...
# Loss for validating
plt.figure()
plt.plot(result1.history['val_loss'], label='SGD')
plt.plot(result2.history['val_loss'], label='RMSProp')
plt.plot(result3.history['val_loss'], label='Adam')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.title('Loss of 3 different optimizers for test data')
plt.show()
...
plt.figure()
plt.plot(result1.history['acc'], label='SGD')
plt.plot(result2.history['acc'], label='RMSProp')
plt.plot(result3.history['acc'], label='Adam')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
plt.title('Accuracy of 3 different optimizers for train data')
plt.show()
...
plt.figure()
plt.plot(result1.history['val_acc'], label='SGD')
plt.plot(result2.history['val_acc'], label='RMSProp')
plt.plot(result3.history['val_acc'], label='Adam')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
plt.title('Accuracy of 3 different optimizers for test data')
plt.show()

# *****************************************************************************
# Plotting Predicted value versus True value for SGD
plt.figure()
plt.scatter(TESTy[:, 0], Y1_Predict[:, 0])
plt.ylabel('Predicted value(Bronx)')
plt.xlabel('True value')
plt.title('True VS Predicted Value for Test Data of SGD optimizer')
plt.show()
...
# *****************************************************************************
# Plotting Predicted value versus True value for RNN
plt.figure()
plt.scatter(TESTy[:, 0], Y2_Predict[:, 0])
plt.ylabel('Predicted value(Bronx)')
plt.xlabel('True value')
plt.title('True VS Predicted Value for Test Data of RMSProp optimizer')
plt.show()
...
print("Training time for LSTM = ", stop2-start2)
...
plt.ylabel('Predicted value(Bronx)')
plt.xlabel('True value')
plt.title('True VS Predicted Value for Test Data of Adam optimizer')
plt.show()
...
plt.title('SGD optimizer: True and Predicted Value for Test Data')
plt.xlabel('Time')
...
# *****************************************************************************
# RMSProp: Plotting the predicted data for four boroughs
plt.figure()
...
plt.title('RMSProp optimizer: True and Predicted Value for Test Data')
plt.xlabel('Time')
plt.ylabel('Values(Bronx)')
plt.legend()
plt.show()
...
plt.title('Adam optimizer: True and Predicted Value for Test Data')
plt.xlabel('Time')
plt.ylabel('Values(Bronx)')
plt.legend()
plt.show()
